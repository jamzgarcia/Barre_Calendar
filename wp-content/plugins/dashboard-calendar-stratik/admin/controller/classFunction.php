...
class adminQuestions
{
  ...
  public function loadAnswers($id_user)
  {
    ...
    $pdf->Image(ABSPATH . "wp-content/plugins/dashboard-calendar-stratik/admin/images/logo.png", null, null, 35, 30);
    ...
    $div_questions .= "</tbody></table>";
    // return $div_questions;
    $dir_ = ABSPATH . "wp-content/plugins/dashboard-calendar-stratik/admin/controller/reports";
    if (!is_dir($dir_))
      mkdir($dir_, 0777, true);
    $name_file = ABSPATH . "wp-content/plugins/dashboard-calendar-stratik/admin/controller/reports/$id_user.pdf";
    $pdf->Output($name_file, "F");
    $name_file = "/wp-content/plugins/dashboard-calendar-stratik/admin/controller/reports/$id_user.pdf";
    // $pdf->Output($name_file,"F");
