...
//	$code = "4154150123456789".chr(102)."802001000000000137".chr(102)."390001582784";
 //	echo "<br>code".$code;
	...
	while ($code > "") {
		...
		if (substr($Cguid,0,$IminiC) == $SminiC) {  
			...
			/*	echo "<br>string".substr($code,$i,2);
				echo "<br>".strval(substr($code,$i,2));
			echo "<br>".chr(strval(substr($code,$i,2)));*/
	...
	/*echo "<br>string".$crypt;
	echo "<br>string".$crypt[$i]."<br>";
	echo "<br>ord".ord($crypt[$i])."<br>";
		print_r ($this->T128[ord($crypt[$i])]);*/
